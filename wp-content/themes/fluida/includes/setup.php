...
function fluida_setup() {
	...
	set_post_thumbnail_size(
		...
		apply_filters( 'fluida_thumbnail_image_height', $fheight ),
		false
	);
	...
	add_image_size( 'fluida-featured-full',
		apply_filters( 'fluida_featured_image_full_width', ceil($options['fluida_sitewidth']) ),
		apply_filters( 'fluida_featured_image_full_height', $fheight ),
		$falign
	);
	add_image_size( 'fluida-featured-half',
		apply_filters( 'fluida_featured_image_half_width', 800 ),
		apply_filters( 'fluida_featured_image_falf_height', $fheight ),
		$falign
	);
	add_image_size( 'fluida-featured-third',
		apply_filters( 'fluida_featured_image_third_width', 512 ),
		apply_filters( 'fluida_featured_image_third_height', $fheight ),
		$falign
	);
	
	// a separate 'square' forced crop for those special edge cases
	add_image_size( 'fluida-featured-square',
		apply_filters( 'fluida_featured_image_square_width', 350 ),
		apply_filters( 'fluida_featured_image_square_height', 350 ),
		array( 'center', 'center' )
	);
